...
const RULE_CONTENT_V6=[
["job-common","職業・市民ルール","ジョブ共通ルール","ジョブ共通ルール",`各ジョブに就くプレイヤーは、その職業に応じた責任を持って行動してください。職業は金策だけではなく、街のRPや市民生活を支える役割です。

## 出退勤
犯罪が許可されている職業は、**犯罪準備シーン開始から逃走シーン終了まで退勤**してください。

指名手配された後の出勤可否や店舗での扱いは、**各店舗のRP・内部判断**に任せます。警察・EMS・メカニックなど犯罪が禁止されている職業は、各職業の個別ルールを優先します。

放置状態、業務と関係のない行動を継続する場合、長時間音声を聞けず対応できない状態では出勤を維持しないでください。

## 職業専用品
職業専用として支給・利用できる物資・装備は、原則として**出勤中のみ携帯・使用可能**です。退勤時は所定の場所へ収納してください。

**一般市民への譲渡は禁止**です。ただし、正式に販売商品として認められているものは除きます。AFAKはEMS専用品ではなく別枠で扱います。

## 経済バランス
無料配布、過度な値引き、不正な利益供与、街の経済バランスを大きく崩す汚職は禁止です。個別の最低価格・料金規定がある場合は、そちらを優先します。`,"card","職業"],
["owners","職業・市民ルール","オーナー・サブオーナー","経営・統括役職について",`店舗・会社のオーナー／サブオーナー、ギャングのボス／アンダーボスなど、**組織を経営・統括する役職同士を兼任することはできません。**

代表者や経営者を変更する場合は、事前に運営へ申請し、承認を受けてください。

兼業についてはJob上限および各職業の個別ルールを優先します。`,"text","職業,店舗,組織"],
["job-points","職業・市民ルール","違反ポイント","組織違反ポイント",`警察・EMS・メカニック・店舗／会社・ギャングなど、組織や職業の活動中に違反が確認された場合、**組織への違反ポイント**と**本人への個人ペナルティ**は別々に判断します。

| ポイント | 基本対応 |
| --- | --- |
| **1ポイント** | **厳重注意** |
| **2ポイント** | **市への組織罰金**（金額はその都度運営から通知） |
| **3ポイント** | **組織ごとの重大処分** |

3ポイント時は、ギャングは強制解体、店舗・会社・メカニックは強制閉業の対象です。警察・EMSは組織罰金および必要な改善措置を運営判断で行います。

**違反ポイントは、最後にポイントが付与されてから1ヶ月間、新たな違反がなければ1ポイント減少します。**\n\n途中でポイントが追加された場合は、**その日から1ヶ月を数え直します。** 悪質な違反はポイント数にかかわらず運営判断で対応する場合があります。`,"card","職業,組織"],
["crime-scenes","犯罪ルール","犯罪シーン","犯罪シーンの区分",`## 犯罪準備シーン
犯罪を行うことを決め、準備を始めた時点から犯罪開始直前までを指します。
...
## 指名手配シーン
警察から指名手配された本人にのみ発生します。**逮捕された時点、または指名手配開始から30分経過した時点**で終了します。

指名手配中に別犯罪で新たに指名手配された場合は、別犯罪の指名手配として重ねて扱います。`,"steps","犯罪者"],
["crime-intervention-support","犯罪ルール","犯罪シーン","シーン介入・援護射撃",`## 第三者の介入
犯罪シーンへ第三者として介入し、警察側または犯人側を援助した場合は、**共犯として扱われる場合があります。** 現場にいる・見ているだけで直ちに共犯になるわけではありません。

援護射撃の詳細条件は、**ギャング・組織ルール**および**警察ルール**にそれぞれ記載します。`,"warning","全住民,犯罪者,警察"],
["gang-setup","ギャング・組織ルール","ギャング","ギャングの設立・運営",`ギャングの設立には**5名以上**が必要で、最大**20名**まで所属できます。

申請 → 運営面談 → 審査 → 承認 → **設立費3億円**の支払い後、正式設立となります。

※新たにアジト用MLOを用意する場合は、別途MLO費用がかかります。

設立費は解体理由を問わず返金されません。5名未満になった場合は、**1ヶ月以内に5名以上へ戻してください。**

解体後、同一ボス・アンダーボスを含む再設立は**1ヶ月間禁止**です。名称は解体後**1週間保護**されます。`,"card","ギャング,組織"],
["gang-appearance","ギャング・組織ルール","ギャング","活動服・組織カラー",`ギャングカラーは**1組織1色**です。他ギャングと同色は使用できません。判別が難しいほど似ている場合は調整を求めることがあります。

複数人で犯罪を行う場合は、活動服と車両カラーを統一してください。男性同士・女性同士でそれぞれ活動服を統一し、上半身を中心にギャングカラーが明確に分かる服装にしてください。

車両は**車体の半分以上**を組織カラーにします。犯罪開始後に確保した野良車両はカラー変更不要です。

1人で犯罪を行う場合は、服装・車両カラーの指定はありません。`,"text","ギャング,犯罪者"],
["gang-joint-mercenary","ギャング・組織ルール","組織間の行動","合同・傭兵",`## 合同犯罪
別ギャング所属者が1人でも一緒に犯罪へ参加した場合は合同犯罪です。
...
- 主体ギャングの参加人数を超えないこと
- 依頼元ギャングの活動服を着用
- **傭兵による援護射撃は禁止**`,"text","ギャング,犯罪者"],
["gang-support-fire","ギャング・組織ルール","組織間の行動","ギャング側の援護射撃",`ギャング側の援護射撃は、**運営から許可された自組織アジト範囲内**からのみ可能です。

- 同一組織のメンバーのみ可能
- **傭兵は援護射撃不可**
- 自組織メンバーを助ける目的でのみ使用可能
- 援護射撃のみを行う人は犯罪参加人数に含めません
- 後から通常参加する場合は、その時点から参加人数に含めます
- 援護射撃開始時までに活動服を着用してください
- 一度ダウンした人は、蘇生後に同じシーンの援護射撃へ復帰できません
- 援護射撃側でダウンした場合も同じシーンへ復帰できません

合同犯罪中であっても、別ギャングのアジトから援護射撃することはできません。`,"warning","ギャング,犯罪者"],
["police-fire","警察ルール","発砲・制圧","発砲基準",`## 準小型・小型犯罪
原則として**テーザーで制圧**してください。

実銃は、個別犯罪ルールで使用が認められている場合、または警察官・周囲の人物に**明確な生命の危機**がある場合に使用できます。

銃を所持しているだけ、または逃走しただけでは、原則として実銃を使用する理由にはなりません。

## 中型犯罪以上
**中型犯罪以上は即時発砲可能**です。現場状況とRPを踏まえて対応してください。`,"card","警察"],
["police-siren-heli","警察ルール","車両・装備","サイレン・ヘリコプター",`## サイレン
犯罪対応中にパトカーを運転する際は、サイレンを使用してください。犯罪現場へ向かう時、シーン中に帰還する時、犯罪者を護送する時が対象です。

## ヘリコプター
犯罪対応に出動できるヘリは、犯罪一覧表で定められた台数までです。

ヘリの上限は、**その犯罪対応で使用した総出動数**で数えます。故障・墜落しても使用枠は戻りません。上限内であれば別ヘリを出動できます。

パトカーはこの総出動数方式では数えません。ヘリからの発砲は禁止です。性能・外装を問わずヘリのカスタムは禁止します。`,"notice","警察"],
["police-support-fire","警察ルール","警察側の援護射撃","警察側の援護射撃",`警察側の援護射撃は、**警察署に向かって発砲され、銃弾が警察署へ着弾した場合**に可能です。

- 警察署の許可された範囲内からのみ可能
- 味方警察官・警察署を守る目的で行うこと
- 援護射撃のみを行う警察官は犯罪対応人数に含めません
- 後から通常の犯罪対応へ参加する場合は、その時点から対応人数に含めます
- 一度ダウンした警察官は、蘇生後に同じシーンの援護射撃へ復帰できません
- 現場状況を把握せずに発砲することは禁止です`,"warning","警察"],
["police-corruption","警察ルール","警察内部","汚職について",`警察の汚職はRPとして行うことができます。発覚した場合は、警察上層部で協議し内部処分を決定します。

ただし、**街の経済バランスを大きく崩す汚職や不正な利益供与は禁止**です。

また、警察専用品の横流し、本来発生する罰金を完全に0円にする行為は禁止します。汚職RPによる罰金の減額については、公開ルール上で個別基準を設けません。`,"warning","警察"],
["law-fines","警察ルール","法律・罰金","法律・罰金一覧",`サーバー内ではRP上の法律が存在します。警察は法律に基づいて取り締まりを行い、市民はその場のRPとして対応してください。
...
| 暴行罪 | 50万円 | 他者に暴力を加え、身体へ危害を加える行為 |
| 威力業務妨害罪 | 300万円 | 暴力を用いて業務を妨害する行為 |
| 営業妨害罪 | 100万円 | 正当な理由なく店舗・企業の業務を妨害する行為 |
| 公然わいせつ罪 | 250万円 | 露出の過度に高い服装や、露出部を故意に見せる行為など |
| 銃刀法違反 | 30万円 | 許可なく銃器や刃物などの違法武器を所持・使用する行為 |
| 窃盗罪 | 100万円 | 他人や心なきの所有物を無断で盗む行為 |
| 重窃盗罪（公務員車両） | 200万円 | 警察などの公務車両を窃盗する行為 |
| 違法薬物所持罪 | 20万円 | 違法薬物を所持する行為（1個単位） |
| 違法薬物素材所持罪 | 20万円 | 違法薬物の製造素材を所持する行為（100個ごと） |
| 道路交通法違反 | 30万円 | 危険運転・無免許運転など道路交通上の違反行為 |
| 逃走ほう助罪 | 150万円 | 犯罪者の逃走を手助けする行為 |
| 誘拐・拉致罪 | 50万円 | 相手の意思に反して拘束・連れ去る行為 |
| 殺人罪 | 100万円 | 他者を故意に死亡させる行為（NPCを含む） |
| 公務執行妨害罪 | 50万円 | 警察・EMSなどの公務を妨害する行為 |
...
- **同じ罪状の重ねがけはできません。**
- **異なる罪状は重ねて適用できます。**
- 同一犯罪シーンの仲間が行った罪状は、**原則として共犯者にも同罪が適用**されます。状況によりRPを踏まえて個別判断する場合があります。
- **違法薬物所持罪・違法薬物素材所持罪は共犯の対象外**です。実際に対象物を所持していた本人にのみ適用します。
- 罪状は原則として、警察がRP上把握できたものを適用します。本人が申告した罪状は適用可能です。

## 罰金の対象
通常の罪状による罰金は、**違反した個人に対して科されます。**

**テロ行為は組織単位の罰金となり、逮捕された人1人に請求されます。**

> **注意**：合同犯罪の場合、テロ行為の罰金は**参加した各組織それぞれに科されます。** 各組織の逮捕者1人に請求されます。

**営業妨害罪が適用された場合、被害施設は0～1億円の損害賠償を請求できる権利があります。**`,"card","全住民,警察"],
["weapon-license","職業・市民ルール","武器ライセンス","武器ライセンス",`武器ライセンス所持者は白市民として扱います。

初回取得・再取得ともに、**最後にプリズンへ送致された日から1週間経過後**に取得できます。期間中に再びプリズンへ送致された場合は、その送致日から1週間を数え直します。発行時の手続きは警察とのRPで行います。

プリズン送致時は、**武器ライセンスと所持している武器本体を押収**します。自主返納も可能で、返納した時点で白市民としての扱いも終了します。

武器はライセンスへ手動登録して管理します。登録されていない対象武器の所持は**違法所持**です。登録武器は本人のみ所持・使用でき、貸与は禁止です。正式に譲渡する場合は登録変更を行ってください。`,"card","全住民,警察"],
["driver-license","職業・市民ルール","武器ライセンス","運転免許証",`運転免許証は最初から所持しています。車・バイク・ヘリ・船などを分けず、**すべて同一の運転免許証**で扱います。

犯罪で車両を運転して逃走した場合は、運転免許証を押収します。再取得は武器ライセンスと同じく、**最後にプリズンへ送致された日から1週間経過後**です。

免許を所持していない状態で運転・操縦した場合は、**道路交通法違反（30万円）**として扱います。道路交通法のみではプリズン送致されないため、それだけでは再取得までの1週間は数え直しません。他の罪によりプリズンへ送致された場合は、その送致日から数え直します。`,"text","全住民,警察"],
["ems-basic","EMSルール","EMSの基本","EMSの勤務・基本",`EMSは救助・医療RPを担当し、街のRP継続を支える公務員です。

勤務中は、**白色を基調としたEMSと分かる服装**および**EMSデカール**を着用してください。退勤中は治療・蘇生などのEMS業務を行うことはできません。

採用・解雇・階級・昇格・訓練内容は、共通ルールの範囲内でEMS内のRPとして扱います。`,"card","EMS"],
["ems-rescue","EMSルール","救助・医療","救急要請・救助対応",`ダウン通知が来た場合は状況確認へ向かってください。通常の救急要請では、**対応場所は通報者に選んでもらいます。**

誤って通知を送った場合はEMSへ誤操作であることを伝えてください。通知後に周囲の人がダウン者を移動させた場合は、移動したことと現在地をEMSへ伝えてください。

一般市民によるダウン者の搬送は自由です。ただし犯罪シーンへの介入に当たる場合は、犯罪ルールが適用されます。

複数の要請が重なった場合は**市民対応を優先**します。市民要請同士の順番は、距離・状況・緊急性などを踏まえてEMS側で判断します。

治療・搬送の拒否は患者側・EMS側どちらからでもRPとして可能です。必要に応じて当事者同士で話し合って決めてください。`,"text","EMS,全住民"],
["ems-crime-scene","EMSルール","犯罪現場","犯罪・事件現場での対応",`犯罪・事件現場では、**安全が確保されるまで治療・蘇生を行わず待機**してください。救助中に銃撃戦が再開した場合は救助を中断し、安全な場所へ退避します。
...
警察が生存している場合の進入・撤退連絡など、既存の警察指示に関する運用も優先してください。

逃走支援、匿い、犯罪情報の提供など、EMS業務を超えて犯罪へ協力する行為は禁止です。`,"notice","EMS"],
["ems-vehicles","EMSルール","EMSの基本","EMS車両・サイレン",`EMS専用車両は原則として業務目的で使用します。勤務中に飲食物等を買いに行くための移動や、訓練目的での使用は可能です。

EMSヘリの出動・使用はEMS側の現場判断に任せます。

**救急要請の現場へ向かっている最中、および患者を乗せて搬送している最中はサイレン必須**です。`,"notice","EMS"],
["mechanic-setup","メカニックルール","開業・運営","メカニック開業・運営",`メカニックを開業する場合は、市の**営業許可**が必要です。

- 従業員：**5名以上**
- 開業費：**3億円**
- 新たにMLOを用意する場合は、別途MLO費用がかかります

5名未満になった場合は、**1ヶ月以内に5名以上へ戻してください。** 休業は事情を確認したうえで運営判断とし、承認された休業期間中は営業できません。

閉業後、オーナー・サブオーナーは**1ヶ月間**、新しいメカニック・店舗・会社を設立できません。名称は閉業後**1週間保護**されます。

店舗そのものの売買は禁止です。無償譲渡は可能ですが、オーナー・サブオーナー変更には運営承認が必要です。`,"card","メカニック"],
["mechanic-work","メカニックルール","業務・修理","修理・カスタム・インパウンド",`メカニック業務は**出勤中のみ**行えます。服装、専用車両、自分の車両への対応、犯罪目的と分かっている依頼への対応などはRP・店舗判断とします。
...
- 客都合の返金・やり直しは不可
- 店員側のミスは返金・やり直し可能
- 修理途中に依頼者がいなくなった場合はRP

## インパウンド
インパウンドは原則として依頼があった場合のみ行えます。依頼者は問いません。放置車両やNPC車両も依頼があれば対応可能です。

**インパウンド料金：15万円**

取り出せるのは車両所有者本人のみで、メカニックによる代理取り出しはできません。`,"text","メカニック,全住民"],
["mechanic-custom-limit","メカニックルール","禁止事項","カスタム制限",`- **銃火器の取り付け禁止**
- **防弾ガラスの取り付け禁止**（2列目以降の防弾のみ可能）
- 航空機・船舶は**経年劣化・下回りのみ対応可能**
- 航空機・船舶への**エンジン・アーマー取り付け禁止**

その他の性能カスタムは、既存の性能カスタム規定・料金表に従ってください。`,"warning","メカニック,全住民"],
["company-setup","店舗・会社ルール","設立・開業","会社・店舗の設立",`店舗・会社の設立には、市との面談を行い**営業許可**を受ける必要があります。

- 従業員：**3名以上**
- 開業費：**3,000万円**
- 新たにMLOを用意する場合は、別途MLO費用がかかります

3名未満になった場合は、**1ヶ月以内に3名以上へ戻してください。**`,"card","店舗,会社"],
["company-operation","店舗・会社ルール","営業・運営","店舗・会社の運営",`営業許可を受けた業種・内容の範囲で営業してください。

**業種以外の商品・サービスを新たに取り扱う場合は、再度市との面談が必要です。** 承認範囲内での価格変更、セール、イベント、キャンペーンは自由に行えます。新商品等は既存規約に従ってください。

休業は事情を確認したうえで運営判断とし、承認された休業期間中は営業できません。

店舗そのものの売買は禁止です。無償譲渡は可能ですが、経営者変更は運営承認が必要です。`,"text","店舗,会社"]
];

async function applyRuleContentV6(db){
 const marker=await db.prepare("SELECT value FROM site_settings WHERE key='rule_content_v6_applied'").first();
 if(marker?.value==='1')return;
 for(const r of RULE_CONTENT_V6){
  const [sl,ma,mi,title,content,layout,tags]=r;
  const [majorId,middleId]=await ensureSection(db,ma,mi);
  const old=await db.prepare("SELECT * FROM rules WHERE slug=? LIMIT 1").bind(sl).first();
  if(old){
   await hist(db,old,"2026-08-17 ルール更新前","ルール更新");
   await db.prepare(`UPDATE rules SET category=?,title=?,content=?,major_id=?,middle_id=?,layout_type=?,tags=?,is_published=1,retired_at=NULL,change_note='2026-08-17 ルール更新',edited_by='ルール更新',updated_at=CURRENT_TIMESTAMP WHERE id=?`).bind(ma,title,content,majorId,middleId,layout,tags,old.id).run();
  }else{
   const so=await next(db,"rules",middleId?"WHERE middle_id=?":"WHERE middle_id IS NULL",middleId?[middleId]:[]);
   await db.prepare(`INSERT INTO rules(slug,category,title,summary,content,display_type,is_published,sort_order,keywords,details,details_collapsed,change_note,new_until,major_id,middle_id,is_required,edited_by,layout_type,tags,created_at,updated_at)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)`).bind(sl,ma,title,"",content,"normal",1,so,"","",1,"2026-08-17 ルール追加",null,majorId,middleId,0,"ルール更新",layout,tags).run();
  }
 }
 await db.prepare("UPDATE rules SET content=REPLACE(content,'営業ライセンス','営業許可') WHERE content LIKE '%営業ライセンス%'").run();
 await db.prepare("UPDATE rules SET content=REPLACE(content,'牽引','インパウンド') WHERE content LIKE '%牽引%'").run();
 await db.prepare("INSERT INTO site_settings(key,value,updated_at,edited_by) VALUES('rule_content_v6_applied','1',CURRENT_TIMESTAMP,'ルール更新') ON CONFLICT(key) DO UPDATE SET value='1',updated_at=CURRENT_TIMESTAMP,edited_by='ルール更新'").run();
}
...
export default{async fetch(req,env){const u=new URL(req.url);
 ...
 await schema(env.DB);
 try{await normalizeOfficialStructure(env.DB);await seedInitialRules(env.DB);await applyRuleContentV3(env.DB);await applyRuleContentV4(env.DB);await applyRuleContentV5(env.DB);await applyRuleContentV6(env.DB)}catch(err){console.error("rule migration skipped",err)}
 ...
 if(m&&req.method==="DELETE"){const id=+m[1],mc=+(await env.DB.prepare("SELECT COUNT(*) n FROM rule_middle_titles WHERE major_id=?").bind(id).first())?.n||0,rc=+(await env.DB.prepare("SELECT COUNT(*) n FROM rules WHERE major_id=? OR middle_id IN (SELECT id FROM rule_middle_titles WHERE major_id=?)").bind(id,id).first())?.n||0;if(mc||rc)return J({ok:false,message:mc?`この大タイトルには中タイトルが ${mc}件あります。先に中タイトルを整理してください。`:`この大タイトルはルール ${rc}件で使用されています。`},409);await env.DB.prepare("DELETE FROM rule_major_titles WHERE id=?").bind(id).run();return J({ok:true})}
 ...
 if(m&&req.method==="DELETE"){const id=+m[1],rc=+(await env.DB.prepare("SELECT COUNT(*) n FROM rules WHERE middle_id=?").bind(id).first())?.n||0;if(rc)return J({ok:false,message:`この中タイトルはルール ${rc}件で使用されています。先にルールを移動または削除してください。`},409);await env.DB.prepare("DELETE FROM rule_middle_titles WHERE id=?").bind(id).run();return J({ok:true})}
 ...
 if(m&&req.method==="DELETE"){await env.DB.prepare("DELETE FROM announcements WHERE id=?").bind(+m[1]).run();return J({ok:true})}
 ...
 if(m&&req.method==="DELETE"){await env.DB.prepare("DELETE FROM faqs WHERE id=?").bind(+m[1]).run();return J({ok:true})}
